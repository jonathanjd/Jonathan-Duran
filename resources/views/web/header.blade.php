            ...
            <div class="collapse navbar-collapse text-center" id="bs-example-navbar-collapse-1">
                <div class="col-md-8 col-xs-12 nav-wrap">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{ route('cursos') }}" class="">Cursos</a></li>
    ...
    <div id="owl-hero" class="owl-carousel owl-theme">
        <div class="item" style="background-image: url({{ asset('template-web/img/sliders/blog-clon.jpg') }})">
            <div class="caption">
                ...
                <a class="btn btn-transparent page-scroll" href="#services">Más Información</a><a class="btn btn-light page-scroll" href="{{ route('presupuesto.index') }}">Presupuesto</a>
            </div>
        </div>
