...
<br>
<strong>Nombre del Cliente:&nbsp;</strong>{!! $customer !!}<br>
<br>
<strong>Correo:&nbsp;</strong>{!! $email !!}<br>
<br>
<strong>Mensaje:&nbsp;</strong>{!! $mensaje !!}<br>
<br>
<strong>Diseño: </strong>{!! $name_design !!}<br>
<br>
<strong>Ver Demo:</strong> {!! $demo !!}<br>
<br>
<strong>Servicio de Blog:</strong> {!! $blog !!}<br>
<br>
<strong>Servicio de Carrito de Compra:</strong> {!! $car !!}<br>
<br>
<strong>Total a Pagar:</strong> {!! $total !!} BsF<br>
&nbsp;<br>
