						...
						<div class="col-md-4 col-sm-12 col-xs-12">
		                    <div class="plan featured">
		                        <div class="plan-header">
		                            ...
		                            <a href="{{ route('servicio',$plan) }}" class="button red button-3d rounded effect icon-bottom"><span><i class="fa fa-plus-circle"></i>Más Información</span></a>
		                        </div>
		                        <div class="plan-list">
		                            <ul>
						...
						<div class="col-md-4 col-sm-12 col-xs-12">
		                    <div class="plan">
		                        <div class="plan-header">
		                            ...
		                            <a href="{{ route('servicio',$plan) }}" class="button black-light button-3d rounded effect icon-bottom"><span><i class="fa fa-plus-circle"></i>Más Información</span></a>
		                        </div>
		                        <div class="plan-list">
