...
@section('meta')
  ...
  <meta name="description" content="Blog - Creamos sitios web de alta calidad, Diseño web, Aplicaciones Web, Blog Clon ofrece páginas web accesibles, posicionamiento en buscadores, servicios profesionales en sitios web, paginas web dinamicas. Diseño de paginas web económicas" />
  ...
  <meta property="og:image" content="{{ asset('imagen/facebook-share-blog.jpg') }}" />
  ...
  <meta name="twitter:image" content="{{ asset('imagen/facebook-share-blog.jpg') }}">
@endsection
                  ...
                  <br>
  					...
  					<div class="post-meta">
  						<div class="post-date">
  							...
  							<span class="post-date-month">{{ $post->created_at->format('F') }}</span>
    ...
    <div class="row">
      ...
      <ul class="rrssb-buttons clearfix">
        ...
        <li class="rrssb-facebook">
          ...
          <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('blog') }}" class="popup">
        ...
        <li class="rrssb-twitter">
          ...
          <a href="https://twitter.com/intent/tweet?text={{ route('blog') }}"
          class="popup">
        ...
        <li class="rrssb-linkedin">
          <!-- Replace href with your meta and URL information -->
          <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('blog') }}&amp;title=Blog%20Clone%20Creamos%20Sitios%20Web&amp;summary=Responsive%20social%20icons%20by%20KNI%20Labs" class="popup">
        ...
        <li class="rrssb-googleplus">
          <!-- Replace href with your meta and URL information.  -->
          <a href="https://plus.google.com/share?url={{ route('blog') }}" class="popup">
            <span class="rrssb-icon">
        ...
        <li class="rrssb-pinterest">
          <!-- Replace href with your meta and URL information.  -->
          <a href="http://pinterest.com/pin/create/button/?url={{ route('blog') }}&amp;media={{ asset('imagen/facebook-share-blog.jpg') }}&amp;description=Creamos%20Sitios%20Web%20Únicos%20y%20Seguros.">
            <span class="rrssb-icon">
