...
@section('meta')
  ...
  <meta name="twitter:title" content="{{ $design->share->title }}">
  <meta name="twitter:description" content="{{ $design->share->description }}">
  <meta name="twitter:image" content="{{ asset('share/'.$design->share->image) }}">
@endsection
