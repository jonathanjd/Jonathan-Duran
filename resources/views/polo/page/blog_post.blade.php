...
@section('meta')
  ...
  <!-- sample fb meta -->
  <meta property="og:title" content="{{ $post->share->title }}" />
  	...
  	<div class="container">
          ...
          <div class="breadcrumb col-md-4">
              <ul>
                  ...
                  <li class="active"><a href="#">{{ $post->title }}</a>
                  </li>
              </ul>
          </div>
      </div>
        ...
        <div class="post-content post-classic post-content-single col-md-9">
          ...
          <ul class="rrssb-buttons clearfix">
            ...
            <li class="rrssb-facebook">
              ...
              <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('blog_post', $post->slug) }}" class="popup">
            ...
            <li class="rrssb-twitter">
              ...
              <a href="https://twitter.com/intent/tweet?text={{ route('blog_post', $post->slug) }}"
              class="popup">
            ...
            <li class="rrssb-linkedin">
              <!-- Replace href with your meta and URL information -->
              <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('blog_post', $post->slug) }}&amp;title=Blog%20Clone%20Creamos%20Sitios%20Web&amp;summary=Responsive%20social%20icons%20by%20KNI%20Labs" class="popup">
            ...
            <li class="rrssb-googleplus">
              <!-- Replace href with your meta and URL information.  -->
              <a href="https://plus.google.com/share?url={{ route('blog_post', $post->slug) }}" class="popup">
                <span class="rrssb-icon">
            ...
            <li class="rrssb-pinterest">
              <!-- Replace href with your meta and URL information.  -->
              <a href="http://pinterest.com/pin/create/button/?url={{ route('blog_post', $post->slug) }}&amp;media={{ asset('post/'. $post->images[0]->name) }}&amp;description=Creamos%20Sitios%20Web%20Únicos%20y%20Seguros.">
                <span class="rrssb-icon">
