...
@section('meta')
  ...
  <meta property="og:url" content="{{ route('diseños') }}" />
  <meta property="og:image" content="{{ asset('imagen/facebook-share-diseño.jpg') }}" />
  ...
  <meta name="twitter:image" content="{{ asset('imagen/facebook-share-diseño.jpg') }}">
@endsection
              ...
              @foreach ($designs as $design)
                <div class="portfolio-item design">
                    ...
                    <div class="portfolio-details">
                        ...
                        <br />
                        <a href="{{ route('diseño_details',$design->slug) }}" class="button color rounded button-3d effect icon-top"><span><i class="fa fa-external-link"></i>Más Detalles</span></a>
                    </div>
                </div>
              @endforeach
          </div>
      ...
      <div class="row">
        ...
        <ul class="rrssb-buttons clearfix">
          ...
          <li class="rrssb-facebook">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('diseños') }}" class="popup">
          ...
          <li class="rrssb-twitter">
            ...
            <a href="https://twitter.com/intent/tweet?text={{ route('diseños') }}"
            class="popup">
          ...
          <li class="rrssb-linkedin">
            <!-- Replace href with your meta and URL information -->
            <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('diseños') }}&amp;title=Blog%20Clone%20Creamos%20Sitios%20Web&amp;summary=Responsive%20social%20icons%20by%20KNI%20Labs" class="popup">
          ...
          <li class="rrssb-googleplus">
            <!-- Replace href with your meta and URL information.  -->
            <a href="https://plus.google.com/share?url={{ route('diseños') }}" class="popup">
              <span class="rrssb-icon">
          ...
          <li class="rrssb-pinterest">
            <!-- Replace href with your meta and URL information.  -->
            <a href="http://pinterest.com/pin/create/button/?url={{ route('diseños') }}&amp;media={{ asset('imagen/facebook-share-diseño.jpg') }}&amp;description=Creamos%20Sitios%20Web%20Únicos%20y%20Seguros.">
              <span class="rrssb-icon">
