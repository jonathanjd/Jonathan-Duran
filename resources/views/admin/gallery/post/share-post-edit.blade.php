...
@section('main_content')
  ...
  <div class="row">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('admin-galeria-post') }}">Galería de Post</a></li>
      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <img class="img img-responsive img-rounded" src="{{ asset('share/'.$post->share->image) }}" alt="">

            {!! Form::open(['route' => ['admin-galeria-share-image-post-update', $post->share->id],'method' => 'PUT','files' => true,'data-parsley-validate' => '']) !!}

            <div class="form-group">
              {!! Form::label('title','Title:',['class' => 'control-label']) !!}
              {!! Form::text('title', $post->share->title,['class' => 'form-control', 'required' => '']) !!}
            </div>

            <div class="form-group">
              {!! Form::label('description','Description:',['class' => 'control-label']) !!}
              {!! Form::text('description', $post->share->description,['class' => 'form-control', 'required' => '']) !!}
            </div>
      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <img class="img img-responsive img-rounded" src="{{ asset('post/'.$post->images[0]->name) }}" alt="">
