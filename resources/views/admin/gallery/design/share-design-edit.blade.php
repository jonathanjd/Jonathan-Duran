...
@section('main_content')
  ...
  <div class="row">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('admin-galeria-design') }}">Galería de Design</a></li>
      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <img class="img img-responsive img-rounded" src="{{ asset('share/'.$design->share->image) }}" alt="">

            {!! Form::open(['route' => ['admin-galeria-share-image-design-update', $design->share->id],'method' => 'PUT','files' => true,'data-parsley-validate' => '']) !!}

            <div class="form-group">
              {!! Form::label('title','Title:',['class' => 'control-label']) !!}
              {!! Form::text('title', $design->share->title,['class' => 'form-control', 'required' => '']) !!}
            </div>

            <div class="form-group">
              {!! Form::label('description','Description:',['class' => 'control-label']) !!}
              {!! Form::text('description', $design->share->description,['class' => 'form-control', 'required' => '']) !!}
            </div>
      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <img class="img img-responsive img-rounded" src="{{ asset('design/'.$design->image) }}" alt="">

            <h3 class="text-center">{{ $design->name }}</h3>
