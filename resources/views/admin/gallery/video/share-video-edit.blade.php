      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <img class="img img-responsive img-rounded" src="{{ asset('share/'.$video->share->image) }}" alt="">

            {!! Form::open(['route' => ['admin-galeria-share-image-video-update', $video->share->id],'method' => 'PUT','files' => true,'data-parsley-validate' => '']) !!}

            <div class="form-group">
              {!! Form::label('title','Title:',['class' => 'control-label']) !!}
              {!! Form::text('title', $video->share->title,['class' => 'form-control', 'required' => '']) !!}
            </div>

            <div class="form-group">
              {!! Form::label('description','Description:',['class' => 'control-label']) !!}
              {!! Form::text('description', $video->share->description,['class' => 'form-control', 'required' => '']) !!}
            </div>
