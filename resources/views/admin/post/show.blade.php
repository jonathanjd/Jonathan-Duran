...
<div class="app">
	<div class="row">
		<div class="col-md-6 col-sm-6 col-xs-12">
			...
			<a href="{{ route('admin-galeria-share-image-post', $post) }}" class="btn btn-primary btn-block" data-toggle="tooltip" data-placement="bottom" title="CEO - Redes Sociales"><i class="fa fa-facebook-square"></i></a>
			<a href="{{ route('admin.post.index') }}" class="btn btn-primary btn-block" data-toggle="tooltip" data-placement="bottom" title="Regresar"><i class="fa fa-arrow-left"></i></a>
