  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <li><a><i class="fa fa-pencil"></i> Publicaciones <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('admin.post.index') }}">Inicio</a></li>
          <li><a href="{{ route('admin.post.create') }}">Crear</a></li>
        </ul>
      </li>

      <li><a><i class="fa fa-tag"></i> Tags <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('admin.tag.index') }}">Inicio</a></li>
          <li><a href="{{ route('admin.tag.create') }}">Crear</a></li>
        </ul>
      </li>
  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <li><a><i class="fa fa-folder"></i> Planes <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('admin.plan.index') }}">Inicio</a></li>
          <li><a href="{{ route('admin.plan.create') }}">Crear</a></li>
        </ul>
      </li>

      <li><a><i class="fa fa-cubes"></i> Cursos <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('admin.course.index') }}">Inicio</a></li>
          <li><a href="{{ route('admin.course.create') }}">Crear</a></li>
        </ul>
      </li>

      <li><a><i class="fa fa-youtube-play"></i> Videos <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('admin.video.index') }}">Inicio</a></li>
          <li><a href="{{ route('admin.video.create') }}">Crear</a></li>
        </ul>
      </li>
