...
@section('title', 'Creamos Páginas Web Únicos y Seguros')
@section('content')
...
<!-- TITLE & START -->
@include('front-end.partials.title')
<!-- END TITLE & START -->
...
<!-- HIDDEN LOGIN MODAL -->
@include('front-end.partials.acceder')
<!-- END HIDDEN LOGIN MODAL -->

<!-- HIDDEN SIGNUP MODAL -->
@include('front-end.partials.registrar')
