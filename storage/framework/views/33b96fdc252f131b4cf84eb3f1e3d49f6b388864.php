...
<?php $__env->startSection('meta'); ?>
  ...
  <!-- sample fb meta -->
  <meta property="og:title" content="Blog - <?php echo e($post->title); ?>" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="<?php echo e(route('blog_post', $post->slug)); ?>" />
  <meta property="og:image" content="<?php echo e(asset('post/'. $post->images[0]->name)); ?>" />
  <meta property="og:description" content="<?php echo e($post->title); ?> - Creamos sitios web de alta calidad, Diseño web, Aplicaciones Web, Blog Clon ofrece páginas web accesibles, posicionamiento en buscadores, servicios profesionales en sitios web, paginas web dinamicas. Diseño de paginas web económicas."/>

  <!-- sample twitter meta -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:site" content="@nytimes">
  <meta name="twitter:creator" content="@ClonBlog">
  <meta name="twitter:title" content="Blog - <?php echo e($post->title); ?>">
  <meta name="twitter:description" content="<?php echo e($post->title); ?> - Creamos sitios web de alta calidad, Diseño web, Aplicaciones Web, Blog Clon ofrece páginas web accesibles, posicionamiento en buscadores, servicios profesionales en sitios web, paginas web dinamicas. Diseño de paginas web económicas.">
  <meta name="twitter:image" content="<?php echo e(asset('post/'. $post->images[0]->name)); ?>">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content_part'); ?>

  <!-- PAGE TITLE -->
  <section id="page-title" class="page-title-parallax page-title-center text-dark" style="background-image:url('/template-polo/images/parallax/blog-blog-clon.jpg');">
  	<div class="container">
          ...
          <div class="breadcrumb col-md-4">
              <ul>
                  ...
                  <li class="active"><a href="#"><?php echo e($post->title); ?></a>
                  </li>
              </ul>
          </div>
      </div>
        ...
        <div class="post-content post-classic post-content-single col-md-9">
          ...
          <ul class="rrssb-buttons clearfix">
            ...
            <li class="rrssb-facebook">
              ...
              <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(route('blog_post', $post->slug)); ?>" class="popup">
            ...
            <li class="rrssb-twitter">
              ...
              <a href="https://twitter.com/intent/tweet?text=<?php echo e(route('blog_post', $post->slug)); ?>"
              class="popup">
            ...
            <li class="rrssb-linkedin">
              <!-- Replace href with your meta and URL information -->
              <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo e(route('blog_post', $post->slug)); ?>&amp;title=Blog%20Clone%20Creamos%20Sitios%20Web&amp;summary=Responsive%20social%20icons%20by%20KNI%20Labs" class="popup">
            ...
            <li class="rrssb-googleplus">
              <!-- Replace href with your meta and URL information.  -->
              <a href="https://plus.google.com/share?url=<?php echo e(route('blog_post', $post->slug)); ?>" class="popup">
                <span class="rrssb-icon">
            ...
            <li class="rrssb-pinterest">
              <!-- Replace href with your meta and URL information.  -->
              <a href="http://pinterest.com/pin/create/button/?url=<?php echo e(route('blog_post', $post->slug)); ?>&amp;media=<?php echo e(asset('post/'. $post->images[0]->name)); ?>&amp;description=Creamos%20Sitios%20Web%20Únicos%20y%20Seguros.">
                <span class="rrssb-icon">
