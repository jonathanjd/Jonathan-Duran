<section class="p-b-40 background-grey">
            <div class="container">
                ...
                <div class="heading heading text-left">
                    <h2>OUR BLOG</h2>
                    <span class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </span>
                </div>
            </div>
                    ...
                    <div class="post-content post-modern post-block post-4-columns">
                        ...
                        <div class="post-item" data-animation="flipInY" data-animation-delay="0">
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="<?php echo e(asset('template-polo/images/blog/thumb/7.jpg')); ?>">
                                </a>
                            </div>
                        ...
                        <div class="post-item" data-animation="flipInY" data-animation-delay="200">
                            ...
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="<?php echo e(asset('template-polo/images/blog/thumb/8.jpg')); ?>">
                                </a>
                            </div>
                        ...
                        <div class="post-item" data-animation="flipInY" data-animation-delay="400">
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="<?php echo e(asset('template-polo/images/blog/thumb/9.jpg')); ?>">
                                </a>
                            </div>
                            <div class="post-content-details">
                                <div class="post-title">
                        ...
                        <div class="post-item" data-animation="flipInY" data-animation-delay="0">
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="<?php echo e(asset('template-polo/images/blog/thumb/12.jpg')); ?>">
                                </a>
                            </div>
                            <div class="post-content-details">
                                <div class="post-title">
