...
<?php $__env->startSection('meta'); ?>
  ...
  <!-- sample fb meta -->
  <meta property="og:title" content="Servicio Web - <?php echo e($plan->name); ?>" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="<?php echo e(route('servicio',$plan->slug)); ?>" />
  <meta property="og:image" content="<?php echo e(asset('imagen/facebook-share-servicio.jpg')); ?>" />
  <meta property="og:description" content="<?php echo e($plan->name); ?> - Creamos sitios web de alta calidad, Diseño web, Aplicaciones Web, Blog Clon ofrece páginas web accesibles, posicionamiento en buscadores, servicios profesionales en sitios web, paginas web dinamicas. Diseño de paginas web económicas."/>

  <!-- sample twitter meta -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:site" content="@ClonBlog">
  <meta name="twitter:creator" content="@ClonBlog">
  <meta name="twitter:title" content="Servicio Web - <?php echo e($plan->name); ?>">
  <meta name="twitter:description" content="<?php echo e($plan->name); ?> - Creamos sitios web de alta calidad, Diseño web, Aplicaciones Web, Blog Clon ofrece páginas web accesibles, posicionamiento en buscadores, servicios profesionales en sitios web, paginas web dinamicas. Diseño de paginas web económicas.">
  <meta name="twitter:image" content="<?php echo e(asset('imagen/facebook-share-servicio.jpg')); ?>">
    ...
    <div class="row m-b-60">
      <div class="col-md-6">
        ...
        <div class="text-center">
          <a class="button color button-3d rounded effect fill-vertical" href="<?php echo e(route('servicio_contratar',$plan->slug)); ?>"><span>CONTRATAR</span></a>
        </div>
      ...
      <div class="col-md-6">
        ...
        <div class="list-group">
          ...
          <a href="<?php echo e(route('servicio', $plan->slug)); ?>" class="list-group-item">
    ...
    <div class="row">
      ...
      <ul class="rrssb-buttons clearfix">
        ...
        <li class="rrssb-facebook">
          ...
          <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(route('servicio',$plan->slug)); ?>" class="popup">
        ...
        <li class="rrssb-twitter">
          ...
          <a href="https://twitter.com/intent/tweet?text=<?php echo e(route('servicio',$plan->slug)); ?>"
          class="popup">
        ...
        <li class="rrssb-linkedin">
          <!-- Replace href with your meta and URL information -->
          <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo e(route('servicio',$plan->slug)); ?>&amp;title=Blog%20Clone%20Creamos%20Sitios%20Web&amp;summary=Responsive%20social%20icons%20by%20KNI%20Labs" class="popup">
        ...
        <li class="rrssb-googleplus">
          <!-- Replace href with your meta and URL information.  -->
          <a href="https://plus.google.com/share?url=<?php echo e(route('servicio',$plan->slug)); ?>" class="popup">
            <span class="rrssb-icon">
        ...
        <li class="rrssb-pinterest">
          <!-- Replace href with your meta and URL information.  -->
          <a href="http://pinterest.com/pin/create/button/?url=<?php echo e(route('servicio',$plan->slug)); ?>&amp;media=<?php echo e(asset('imagen/facebook-share-servicio.jpg')); ?>&amp;description=Creamos%20Sitios%20Web%20Únicos%20y%20Seguros.">
            <span class="rrssb-icon">
