...
<div class="row">
  ...
  <div class="x_content">
    ...
    <?php echo Form::open(['route' => 'admin.service.store','method' => 'POST','class' => 'form-horizontal form-label-left input_mask','files' => true,'data-parsley-validate' => '']); ?>
      ...
      <div class="form-group">
        ...
        <?php echo Form::textarea('description',null,['class' => 'form-control', 'placeholder' => 'Description Service', 'required' => '','data-parsley-length' => '[10,1000]']); ?>
      ...
      <div class="form-group">
        ...
        <?php echo Form::text('price',null,['class' => 'form-control','placeholder' => 'Price Service','required' => '','data-parsley-range' => '[0,1000000]','data-parsley-type' => 'integer']); ?>
      ...
      <div class="form-group">
        ...
        <?php echo Form::select('available', ['1' => 'Si', '0' => 'No '], '1',['class' => 'form-control']); ?>
