...
<?php $__env->startSection('main_content'); ?>
  ...
  <div class="row">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(route('admin-galeria-course')); ?>">Galería de Course</a></li>
      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <img class="img img-responsive img-rounded" src="<?php echo e(asset('share/'.$course->share->image)); ?>" alt="">

            <?php echo Form::open(['route' => ['admin-galeria-share-image-course-update', $course->share->id],'method' => 'PUT','files' => true,'data-parsley-validate' => '']); ?>


            <div class="form-group">
              <?php echo Form::label('title','Title:',['class' => 'control-label']); ?>

              <?php echo Form::text('title', $course->share->title,['class' => 'form-control', 'required' => '']); ?>
            ...
            <div class="form-group">
              ...
              <?php echo Form::text('description', $course->share->description,['class' => 'form-control', 'required' => '']); ?>
      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <img class="img img-responsive img-rounded" src="<?php echo e(asset('course/'.$course->image)); ?>" alt="">
