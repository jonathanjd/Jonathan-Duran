...
<?php $__env->startSection('meta'); ?>
  ...
  <!-- sample fb meta -->
  <meta property="og:title" content="Cursos de Programación Web" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="<?php echo e(route('cursos')); ?>" />
  <meta property="og:image" content="<?php echo e(asset('imagen/facebook-share-curso.jpg')); ?>" />
  ...
  <meta name="twitter:title" content="Cursos de Programación Web">
  ...
  <meta name="twitter:image" content="<?php echo e(asset('imagen/facebook-share-curso.jpg')); ?>">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content_part'); ?>

  <!-- PAGE TITLE -->
  <section id="page-title" class="page-title-parallax page-title-center text-dark" style="background-image:url(/template-polo/images/parallax/cursos-blogclon.jpg);">
      <div class="container">
          <div class="page-title col-md-8">
              <h1>Cursos de Programación</h1>
              <span><strong>Cursos de Programación WEB Totalmente Gratis.</strong></span>
          </div>
      </div>
  </section>
  <!-- END: PAGE TITLE -->
              ...
              <?php foreach($cursos as $curso): ?>
                <div class="portfolio-item design">
                    <div class="portfolio-image effect social-links">
                        <img src="<?php echo e(asset('course/'.$curso->image)); ?>" alt="">
                        <div class="image-box-content">
                            <p>
                                <a href="<?php echo e(asset('course/'.$curso->image)); ?>" data-lightbox-type="image" title="<?php echo e($curso->name); ?>"><i class="fa fa-expand"></i></a>
                                <a href="<?php echo e(route('curso_mostrar', $curso->slug)); ?>" target="_blank" title="Ver Demo"><i class="fa fa-link"></i></a>
                            </p>
                        </div>
                    </div>
                    <div class="portfolio-description">
                        <h4 class="title"><?php echo e($curso->name); ?></h4>
                        <p><i class="fa fa-tag"></i>Programación Web</p>
                    </div>
                    <div class="portfolio-date">
                        <p class="small"><i class="fa fa-calendar-o"></i><?php echo e($curso->created_at->diffForHumans()); ?></p>
                    </div>

                    <div class="portfolio-details">
                        <p class="text-justify"><?php echo $curso->content; ?></p>
                        <br />
                        <a href="<?php echo e(route('curso_mostrar', $curso->slug)); ?>" class="button color rounded button-3d effect icon-top"><span><i class="fa fa-external-link"></i>Más Detalles</span></a>
                    </div>
                </div>
              <?php endforeach; ?>
          </div>
      ...
      <div class="row">
        ...
        <ul class="rrssb-buttons clearfix">
          ...
          <li class="rrssb-facebook">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(route('cursos')); ?>" class="popup">
          ...
          <li class="rrssb-twitter">
            ...
            <a href="https://twitter.com/intent/tweet?text=<?php echo e(route('cursos')); ?>"
            class="popup">
          ...
          <li class="rrssb-linkedin">
            <!-- Replace href with your meta and URL information -->
            <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo e(route('cursos')); ?>&amp;title=Blog%20Clone%20Creamos%20Sitios%20Web&amp;summary=Responsive%20social%20icons%20by%20KNI%20Labs" class="popup">
          ...
          <li class="rrssb-googleplus">
            <!-- Replace href with your meta and URL information.  -->
            <a href="https://plus.google.com/share?url=<?php echo e(route('cursos')); ?>" class="popup">
              <span class="rrssb-icon">
          ...
          <li class="rrssb-pinterest">
            <!-- Replace href with your meta and URL information.  -->
            <a href="http://pinterest.com/pin/create/button/?url=<?php echo e(route('cursos')); ?>&amp;media=<?php echo e(asset('imagen/facebook-share-curso.jpg')); ?>&amp;description=Creamos%20Sitios%20Web%20Únicos%20y%20Seguros.">
              <span class="rrssb-icon">
