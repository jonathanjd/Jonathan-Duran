                ...
                <?php echo $__env->make('admin.message-error', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                  ...
                  <?php echo Form::open(['route' => ['admin.post.update',$post],'method' => 'PUT','class' => 'form-horizontal form-label-left input_mask','files' => true,'data-parsley-validate' => '']); ?>
                    ...
                    <div class="form-group">
                      ...
                      <?php echo Form::text('title',$post->title,['class' => 'form-control','placeholder' => 'Ingrese Name','required' => '','data-parsley-length' => '[5,50]']); ?>
                    ...
                    <div class="form-group">
                      ...
                      <?php echo Form::textarea('content',$post->content,['class' => 'form-control trumbowyg-text', 'placeholder' => 'Ingrese Content', 'required' => '','minlength' => '10']); ?>
