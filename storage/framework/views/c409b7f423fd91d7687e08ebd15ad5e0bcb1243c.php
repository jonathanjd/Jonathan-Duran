<section class="main-header">
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(route('index')); ?>"><img src="<?php echo e(asset('template-web/img/logo/logo.png')); ?>" class="img-responsive" alt="logo"></a>
            </div>
    ...
    <div id="owl-hero" class="owl-carousel owl-theme">
        <div class="item" style="background-image: url(<?php echo e(asset('template-web/img/sliders/blog-clon.jpg')); ?>)">
            <div class="caption">
        ...
        <div class="item" style="background-image: url(<?php echo e(asset('template-web/img/sliders/diseño-creativo-blog-clon.jpg')); ?>)">
            <div class="caption">
                <h6>Diseño / Creatividad / Marca</h6>
