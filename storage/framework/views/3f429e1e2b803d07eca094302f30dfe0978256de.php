...
<?php $__env->startSection('meta'); ?>
  ...
  <meta property="og:url" content="<?php echo e(route('servicios')); ?>" />
          ...
          <p>
            ...
            <div class="accordion color">
              ...
              <?php foreach($services as $service): ?>
                ...
                <div class="ac-item">
      						<h5 class="ac-title"><i class="fa fa-star"></i><?php echo e($service->name); ?></h5>

                    <div class="ac-content">
                      <div class="list-group">
                        <?php foreach($service->plans as $plan): ?>

                        <a href="<?php echo e(route('servicio',$plan->slug)); ?>" class="list-group-item"><?php echo e($plan->name); ?></a>
    ...
    <div class="row">
      ...
      <ul class="rrssb-buttons clearfix">
        ...
        <li class="rrssb-facebook">
          ...
          <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(route('servicios')); ?>" class="popup">
        ...
        <li class="rrssb-twitter">
          ...
          <a href="https://twitter.com/intent/tweet?text=<?php echo e(route('servicios')); ?>"
          class="popup">
        ...
        <li class="rrssb-linkedin">
          <!-- Replace href with your meta and URL information -->
          <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo e(route('servicios')); ?>&amp;title=Blog%20Clone%20Creamos%20Sitios%20Web&amp;summary=Responsive%20social%20icons%20by%20KNI%20Labs" class="popup">
        ...
        <li class="rrssb-googleplus">
          <!-- Replace href with your meta and URL information.  -->
          <a href="https://plus.google.com/share?url=<?php echo e(route('servicios')); ?>" class="popup">
            <span class="rrssb-icon">
        ...
        <li class="rrssb-pinterest">
          <!-- Replace href with your meta and URL information.  -->
          <a href="http://pinterest.com/pin/create/button/?url=<?php echo e(route('servicios')); ?>&amp;media=<?php echo e(asset('imagen/facebook-share-servicio.jpg')); ?>&amp;description=Creamos%20Sitios%20Web%20Únicos%20y%20Seguros.">
            <span class="rrssb-icon">
