...
<?php $__env->startSection('title-content-1','Eliminar Curso'); ?>
  ...
  <div>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <img class="img-responsive img-thumbnail center-block" src="<?php echo e(asset('course/'.$course->image)); ?>" alt="">
          <br>
          <?php echo Form::open(['route'=> ['admin.course.destroy',$course->id],'method' => 'DELETE']); ?>
