...
<?php $__env->startSection('title-content-1','Edit-Category | Admin'); ?>

<?php $__env->startSection('title-content-2','Edit-Category | Admin'); ?>
...
<div class="row">
  ...
  <div class="col-md-6 col-xs-12">
    <div class="x_panel">
  <div class="x_title">
    <h2>Form Category <small>Edit</small></h2>
    ...
    <?php echo Form::open(['route' => ['admin.category.update',$category->id],'method' => 'PUT','class' => 'form-horizontal form-label-left input_mask']); ?>
      ...
      <div class="form-group">
        <div class="col-md-9 col-sm-9 col-xs-12">
          <a href="<?php echo e(route('admin.category.index')); ?>" class="btn btn-primary">Cancel</a>
