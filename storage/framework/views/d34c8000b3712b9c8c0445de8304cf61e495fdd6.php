      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <?php echo Form::open(['route' => 'admin-galeria-share-image-video-store','method' => 'POST','files' => true,'data-parsley-validate' => '']); ?>
            ...
            <div class="form-group">
                ...
                <input type="file" name="image" value="" data-field-type="bootstrap-file-filed" data-preview="on" data-file-types="image/jpeg,image/png,image" data-btn-class="btn-primary" required data-parsley-dimensions-options="{'width':'1280','height':'720'}">
            </div>

            <?php echo Form::hidden('video_id', $video->id); ?>
