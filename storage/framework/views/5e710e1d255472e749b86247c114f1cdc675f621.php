...
<body>
    ...
    <?php echo $__env->make('web.page.cursos.navigation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <div class="container">
        ...
        <?php echo $__env->make('web.page.cursos.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
