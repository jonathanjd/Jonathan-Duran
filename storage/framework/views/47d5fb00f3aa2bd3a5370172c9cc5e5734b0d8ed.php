                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
                            ...
                            <h1 style="text-align: center;display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;">Blog Clon - Presupuesto</h1>
<br>
<strong>Nombre del Cliente:&nbsp;</strong><?php echo $customer; ?><br>
<br>
<strong>Correo:&nbsp;</strong><?php echo $email; ?><br>
<br>
<strong>Mensaje:&nbsp;</strong><?php echo $mensaje; ?><br>
<br>
<strong>Diseño: </strong><?php echo $name_design; ?><br>
<br>
<strong>Ver Demo:</strong> <?php echo $demo; ?><br>
<br>
<strong>Servicio de Blog:</strong> <?php echo $blog; ?><br>
<br>
<strong>Servicio de Carrito de Compra:</strong> <?php echo $car; ?><br>
<br>
<strong>Total a Pagar:</strong> <?php echo $total; ?> BsF<br>
&nbsp;<br>
