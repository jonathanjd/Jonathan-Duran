<?php $__env->startSection('title','Editar-Tag'); ?>
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			...
			<div class="x_panel">
				...
				<div class="x_content">
                    ...
                    <?php echo Form::open(['route' => ['admin.tag.update',$tag],'method' => 'PUT','class' => 'form-horizontal form-label-left input_mask','files' => true,'data-parsley-validate' => '']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <?php echo Form::text('name', $tag->name,['class' => 'form-control','data-parsley-required' => '']); ?>
