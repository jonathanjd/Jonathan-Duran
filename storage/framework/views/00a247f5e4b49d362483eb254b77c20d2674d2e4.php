      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <img class="img img-responsive img-rounded" src="<?php echo e(asset('share/'.$design->share->image)); ?>" alt="">

            <?php echo Form::open(['route' => ['admin-galeria-share-image-design-update', $design->share->id],'method' => 'PUT','files' => true,'data-parsley-validate' => '']); ?>


            <div class="form-group">
              <?php echo Form::label('title','Title:',['class' => 'control-label']); ?>

              <?php echo Form::text('title', $design->share->title,['class' => 'form-control', 'required' => '']); ?>
            ...
            <div class="form-group">
              ...
              <?php echo Form::text('description', $design->share->description,['class' => 'form-control', 'required' => '']); ?>
