      ...
      <div class="col-md-6">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <img class="img img-responsive img-rounded" src="<?php echo e(asset('share/'.$post->share->image)); ?>" alt="">

            <?php echo Form::open(['route' => ['admin-galeria-share-image-post-update', $post->share->id],'method' => 'PUT','files' => true,'data-parsley-validate' => '']); ?>


            <div class="form-group">
              <?php echo Form::label('title','Title:',['class' => 'control-label']); ?>

              <?php echo Form::text('title', $post->share->title,['class' => 'form-control', 'required' => '']); ?>
            ...
            <div class="form-group">
              ...
              <?php echo Form::text('description', $post->share->description,['class' => 'form-control', 'required' => '']); ?>
