<?php $__env->startSection('title','Editar-Plan'); ?>
  ...
  <div class="row">
    <div class="col-md-6 col-sm-6 col-xs-12">
     ...
     <a class="btn btn-success btn-block" href="<?php echo e(route('admin.plan.index')); ?>" data-toggle="tooltip" data-placement="bottom" title="Regresar"><i class="fa fa-arrow-left"></i></a>
      ...
      <div class="x_panel">
        <div class="x_title">
          <h2>Form Plan <small>Editar</small></h2>
        ...
        <div class="x_content">
          ...
          <?php echo Form::open(['route' => ['admin.plan.update',$plan],'method' => 'PUT','class' => 'form-horizontal form-label-left input_mask','data-parsley-validate' => '']); ?>


          <div class="form-group">
            <?php echo Form::label('name','Name Plan:'); ?>

            <?php echo Form::text('name',$plan->name,['class' => 'form-control','placeholder' => 'Name Plan','required' => '','data-parsley-length' => '[3,50]']); ?>
          ...
          <div class="form-group">
            ...
            <?php echo Form::number('price',$plan->price,['class' => 'form-control','placeholder' => 'Price Plan','required' => '','data-parsley-type' => 'number']); ?>
          ...
          <div class="form-group">
            ...
            <?php echo Form::text('time',$plan->time,['class' => 'form-control','placeholder' => 'Tiempo de Entrega','required' => '']); ?>
          ...
          <div class="form-group">
            ...
            <?php echo Form::select('enable', ['yes' => 'Si', 'no' => 'No'], $plan->enable,['class' => 'form-control','required' => '']); ?>
          ...
          <div class="form-group">
            ...
            <?php echo Form::select('service_id', $services, $plan->service_id, ['class' => 'form-control','required' => '']); ?>
